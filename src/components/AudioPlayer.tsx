...
export function AudioPlayer({
  ...
  return (
    ...
    >
      {/* Horizontal layout: Player controls + RhymePanel to the right */}
      <div className="flex">
        ...
        {/* Toggle button for rhyme panel */}
        <button
          type="button"
          className="flex items-center justify-center w-6 cursor-pointer focus:outline-none focus-visible:bg-primary-foreground/10 border-l border-primary-foreground/20"
        ...
        >
          {showRhymePanel ? (
            ...
            <ChevronLeft className="h-4 w-4 text-primary-foreground/60" />
          )}
        </button>

        {/* Rhyme suggestions panel — slides from right */}
        <RhymePanel
